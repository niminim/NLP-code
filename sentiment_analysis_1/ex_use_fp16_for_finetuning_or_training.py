...
training_args = TrainingArguments(
    output_dir="sentiment_analysis_first_play/sentiment_analysis_1/results",
    report_to=[],  # Disable all external reporting (Neptune, WandB, etc.) (Neptune is default)
    logging_dir="/home/nim/venv/NLP-code/sentiment_analysis_1/logs",  # Log locally instead (if needed)
...
model.save_pretrained("/home/nim/venv/NLP-code/sentiment_analysis_1/results_manual")
tokenizer.save_pretrained("/home/nim/venv/NLP-code/sentiment_analysis_1/results_manual")
...
model = DistilBertForSequenceClassification.from_pretrained("/home/nim/venv/NLP-code/sentiment_analysis_1/results_manual")
